...
<body>
<h2>디자인패턴 Quiz</h2>
<h4>디자인 패턴에 대한 설명을 보고 알맞은 패턴 종류를 골라주세요!</h4>
<a href="engineer_Main.php"><button>메인으로</button></a>
<a href="d_pattern_list.php"><button>전체보기</button></a>
<hr>
...
<?php foreach ($list as $value) {
    $number += 1;
    ?>
    <div class="choice"><a href="d_pattern_check.php?no=<?php echo $value['no']; ?>&question=<?php echo $random+1; ?>&choice=<?php echo $number; ?>"><?php echo $number.". ".$value['word']; ?></a></div><br>

<?php } ?>

<!--    키보드로 숫자 입력하기-->
<br><br>
<form action="d_pattern_check.php" method="get">
